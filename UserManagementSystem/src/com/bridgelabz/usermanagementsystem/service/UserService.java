...
public class UserService {
	...
	public boolean addUserPermissions(Permissions permissions, String userName, String creatorUser)
		...
		permissionsDao.addPermissions(userId, 3, permissions.getUsersInformationAdd(), permissions.getUsersInformationDelete(),
	...
	public boolean updateUserDetails(Long userId, User user, Permissions permissions) {
		try {
			...
			permissionsDao.updatePermissions(userId, 3, permissions.getUsersInformationAdd(), permissions.getUsersInformationDelete(),
			...
			return permissionsDao.updatePermissions(userId, 6, permissions.getWebPage3Add(), permissions.getWebPage3Delete(),
