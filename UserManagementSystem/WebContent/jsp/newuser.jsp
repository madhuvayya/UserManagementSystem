						...
						<div class="panel-body">
							<table>
									<tr class="permission-table-head">
      									...
      									<td>
      										<span><input name="add" id="add" type="checkbox" onchange="onCheck('add')"> Add</span>
      									</td>
      									<td>
      										<span><input name="delete" id="delete" type="checkbox" onchange="onCheck('delete')"> Delete</span>
      									</td>
      									<td>
      										<span><input name="modify" id="modify" type="checkbox" onchange="onCheck('modify')"> Modify</span>
      									</td>
      									<td>
      										<span><input name="read" id="read" type="checkbox" onchange="onCheck('read')"> Read</span>
      									</td>
    								</tr>
    								<tr>
      									<td>Dashboard</td>
      									<td><input name="dashboard_add" id="dashboard_add" type="checkbox"></td>
      									<td><input name="dashboard_delete" id="dashboard_delete" type="checkbox"></td>
      									<td><input name="dashboard_modify" id="dashboard_modify" type="checkbox"></td>
      									<td><input name="dashboard_read" id="dashboard_read" type="checkbox"></td>
    								</tr>
    								<tr>
      									<td>Settings</td>
      									<td><input name="settings_add" id="settings_add" type="checkbox"></td>
      									<td><input name="settings_delete" id="settings_delete" type="checkbox"></td>
      									<td><input name="settings_modify" id="settings_modify" type="checkbox"></td>
      									<td><input name="settings_read" id="settings_read" type="checkbox"></td>
    								</tr>    								
    								<tr>
      									<td>Users Information</td>
      									<td><input name="user_info_add" id="user_info_add" type="checkbox"></td>
      									<td><input name="user_info_delete" id="user_info_delete" type="checkbox"></td>
      									<td><input name="user_info_modify" id="user_info_modify" type="checkbox"></td>
      									<td><input name="user_info_read" id="user_info_read" type="checkbox"></td>
    								</tr>
    								<tr>
      									<td>Web Page 1</td>
      									<td><input name="w1_add" id="w1_add" type="checkbox"></td>
      									<td><input name="w1_delete" id="w1_delete" type="checkbox"></td>
      									<td><input name="w1_modify" id="w1_modify" type="checkbox"></td>
      									<td><input name="w1_read" id="w1_read" type="checkbox"></td>
    								</tr>
    								<tr>
      									<td>Web Page 2</td>
      									<td><input name="w2_add" id="w2_add" type="checkbox"></td>
      									<td><input name="w2_delete" id="w2_delete" type="checkbox"></td>
      									<td><input name="w2_modify" id="w2_modify" type="checkbox"></td>
      									<td><input name="w2_read" id="w2_read" type="checkbox"></td>
    								</tr>
    								<tr>
      									<td>Web Page 3</td>
      									<td><input name="w3_add" id="w3_add" type="checkbox"></td>
      									<td><input name="w3_delete" id="w3_delete" type="checkbox"></td>
      									<td><input name="w3_modify" id="w3_modify" type="checkbox"></td>
